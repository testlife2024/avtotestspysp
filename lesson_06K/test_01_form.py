...
driver.find_element(By.CSS_SELECTOR,'div:nth-child(2) > div.col-md-4.py-2 > label > input').send_keys('Ленина, 55-3')
driver.find_element(By.CSS_SELECTOR,'div:nth-child(2) > div:nth-child(3) > label > input').send_keys('Москва')
driver.find_element(By.CSS_SELECTOR,'div:nth-child(3) > div:nth-child(1) > label > input').send_keys('test@skypro.com')
driver.find_element(By.CSS_SELECTOR,'div:nth-child(3) > div:nth-child(2) > label > input').send_keys('+7985899998787')
